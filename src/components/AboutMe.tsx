    ...
    <div className='flex flex-col lg:flex-row md:flex-col sm:flex-col pt-5'>
        ...
        <CardFlip isFlipped={isFlipped}>
            ...
            <div key='back'>
                ...
                <p className='font-mono text-left text-gray-600 m-5'>
                    I got re-introduced to coding my senior year of High School where I got 
                    to learn JAVA in AP Computer Science class. I loved creating programs 
                    and decided to go to Santa Barbara City College to gain further knowledge. 
                    I took another Java class, Python, C, Assembly, Data Structure and Algoritmhs.
                    I took those skills to get my Certification at Coding Temple's 
